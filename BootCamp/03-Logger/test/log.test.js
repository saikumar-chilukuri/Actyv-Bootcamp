  ...
  it("it should enter the data to log", done => {
    ...
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have.property("message").eql("I am in first log");
      });
    done();
  });
  /**
  ...
  it("it should enter the data to log", done => {
    ...
    chai
      ...
      .end((err, res) => {
        res.should.have.status(200);
        res.body.should.be.a("string");
        res.body.should.have.property("message").eql("I am in second log");
      });
    done();
  });
  /**
  ...
  it("it should enter the data to log", done => {
    ...
    chai
      ...
      .end((err, res) => {
        res.should.have.status(200);
        res.body.should.be.a("string");
        res.body.should.have.property("message").eql("I am in error log");
      });
    done();
  });
});
